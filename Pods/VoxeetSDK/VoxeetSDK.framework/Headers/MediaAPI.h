...
- (id)initWithLocalPeer:(NSString *)localPeerId audio:(BOOL)audio video:(BOOL)video dolbyVoice:(BOOL)dolbyVoice constraints:(NSDictionary<NSString*, NSString*>*)constraints;
- (void)stop;
