...
- (id)initWithLocalPeer:(NSString*)localPeerId video:(BOOL)video microphone:(BOOL)microphone dolbyVoice:(BOOL)dolbyVoice constraints:(NSDictionary<NSString*, NSString*>*)constraints;
...
- (void)createConnectionWithPeer:(NSString*)peerId isMaster:(BOOL)isMaster completionHandler:(void (^)(NSError*))completionHandler;
- (BOOL)closeConnectionWithPeer:(NSString*)peerId;
- (void)createAnswerForPeer:(NSString*)peerId completionHandler:(void (^)(NSError*))completionHandler;
...
- (void)setMute:(BOOL)mute completionHandler:(void (^)(NSError*))completionHandler;
- (void)setMuteOutput:(BOOL)mute;
- (NSDictionary*)getAlarmsStatus;
- (void)createClientDumpWithCompletion:(void (^)(NSError*, NSData*))completionHandler;
- (void)releaseClientDump;
- (void)setTransparentMode:(BOOL)transparentMode completionHandler:(void (^)(NSError*))completionHandler;
...
- (void)stop;
- (void)dealloc;
- (void)startAudioWithCompletion:(void (^)(NSError*))completionHandler;
- (void)stopAudioWithCompletion:(void (^)(NSError*))completionHandler;
